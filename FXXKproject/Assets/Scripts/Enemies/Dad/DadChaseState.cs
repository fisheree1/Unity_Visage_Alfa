...
public class DadChaseState : IState
{
    ...
    public DadChaseState(DadP manager, DadParameter parameter)
    {
    ...
    public void OnEnter()
    {
        parameter.animator.Play("Dad_chase");
    ...
    public void OnUpdate()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    parameter.animator.Play("Dad_walk");
                    MoveTowardsTarget();
                }
            }
        }
