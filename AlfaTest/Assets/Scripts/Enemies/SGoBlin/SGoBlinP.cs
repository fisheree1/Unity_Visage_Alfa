...
: MonoBehaviour
{
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            if (((transform.localScale.x>0)&&(distance>-parameter.sightArea))||
                ((transform.localScale.x <0) &&(distance <parameter.sightArea)))
            ...
            else
            {
                ...
                TransitionState(SGoBlinStateType.Idle); // �˳�ʱ�л���Idle״̬
            }
        }
    }
    #endregion
