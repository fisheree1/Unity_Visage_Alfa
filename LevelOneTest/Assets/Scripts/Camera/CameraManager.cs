...
public class CameraManager : MonoBehaviour
{
    ...
    {
        if (_currentCamera == cameraFromLeft && (triggerExitDirection.x > 0f || triggerExitDirection.y < 0f))
        {
        ...
        if (_currentCamera == cameraFromRight && (triggerExitDirection.x < 0f || triggerExitDirection.y > 0f))
        {
