...
[System.Serializable] public class SGoBlinParameter
{
...
: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        states.Add(SGoBlinStateType.Damaged, new SGoBlinDamagedState(this, parameter));
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            if (currentState is SGoBlinIdleState || currentState is SGoBlinPatrolState)
                TransitionState(SGoBlinStateType.Chase); // 进入追逐状态
            else if (currentState is SGoBlinAttackState)
        ...
        if (other.CompareTag("PlayerAttack"))
        {
            ...
            if (attackHitbox != null)
            {
                ...
                TakeDamage(damage);
                Debug.Log($"SGoBlin took {damage} damage from Hero's attack");
    ...
    public void TakeDamage(int damage)
    {
        currentHealth -= damage;
            ...
            {
                // �л�������״̬
                TransitionState(SGoBlinStateType.Damaged);
            }
            // ����Ƿ�����
