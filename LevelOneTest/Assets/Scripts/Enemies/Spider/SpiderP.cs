...
[System.Serializable] public class SpiderParameter
{
...
: MonoBehaviour
{
    ...
    void Start()
    {
        ...
        states.Add(SpiderStateType.Damaged, new SpiderDamagedState(this, parameter));
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("PlayerAttack"))
        {
            ...
            if (attackHitbox != null)
            {
                ...
                TakeDamage(damage);
                Debug.Log($"Spider took {damage} damage from Hero's attack");
    ...
    public void TakeDamage(int damage)
    {
        currentHealth -= damage;
            ...
            {
                // �л�������״̬
                TransitionState(SpiderStateType.Damaged);
            }
            // ����Ƿ�����
